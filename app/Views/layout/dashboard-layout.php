...
<head>
  ...
  <title><?= (isset($pageTitle)) ? $pageTitle : 'User Profile'; ?></title>
<base href="../">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/ci4" class="nav-link">Logout</a>
      </li>
    </ul>
          </a>
        </a>
...
<section id="features" class="features">
 ...
 <section id="faq" class="faq">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021-2022 <a href="<?= base_url(); ?>">My Form</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
